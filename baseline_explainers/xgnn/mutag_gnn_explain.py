...
from gnn_model_training import mutag_gcn
...
class gnn_explain():
    def __init__(self, max_node, max_step, target_class, max_iters): 
        ...
        self.gnnNets = mutag_gcn.DisNets()
    ...
    def train(self):
        ...
        ### Load the model 
        checkpoint = torch.load('checkpoint/mutag_gcn.pth')
    ...
    def graph_draw(self, graph):
        ...
        for n in attr:
            ...
            node_color.append(self.color[attr[n]])

        nx.draw(graph,labels=labels, node_color=node_color)
