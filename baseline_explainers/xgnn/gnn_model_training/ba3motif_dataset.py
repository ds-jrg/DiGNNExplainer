...
class BA3Motif(InMemoryDataset):
    splits = ["training", "evaluation", "testing", "ba3"]
    ...
    def processed_file_names(self):
        return ["training.pt", "evaluation.pt", "testing.pt","ba3.pt"]

    def download(self):
        if not osp.exists(osp.join(self.raw_dir,  "BA-3motif.npy")):
            print(
                "raw data of `BA-3motif.npy` doesn't exist, please download in data/BA3 folder from https://github.com/Wuyxin/ReFine/tree/main/data/BA3/raw."
            )
